...
conn = mysql.connector.connect(host=host,user=user, password='', database=database)
cur = conn.cursor()
...
def face():
    ...
    while True:
        ...
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            ...
            cv2.rectangle(frame, (left, top), (right, bottom), (164, 59, 255),2)
            cv2.rectangle(frame, (left, bottom - 35), (right, bottom), (164, 59, 255), cv2.FILLED)
